        ...
        <footer class="bg-black text-white">
            <div class="max-w-7xl mx-auto px-6 py-10">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <!-- Kolom 1: Tentang -->
                    <div>
                        <h3 class="text-lg font-semibold mb-3">Perusahaan Anda</h3>
                        <p class="text-gray-400 text-sm">Membangun solusi digital yang inovatif.</p>
                    </div>
                ...
                <div class="border-t border-gray-800 mt-8 pt-6 text-center">
                    <p class="text-gray-500 text-sm">© 2024 Perusahaan Anda. Semua hak dilindungi.</p>
                </div>
            </div>
        </footer>
    </div>
